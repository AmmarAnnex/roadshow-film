#!/usr/bin/env python3
"""
Professional Analysis Tool for Cinema Model v1.4l - FIXED
Based on industry standards for color science validation
Fixed PyTorch 2.6 weights_only loading issue
"""
...
class ProfessionalColorAnalyzer:
    ...
    def load_model(self):
        """Load the trained v1.4l model - FIXED for PyTorch 2.6"""
        try:
            ...
            # FIXED: Use weights_only=False for trusted checkpoint
    ...
    def analyze_color_reproduction(self, original, transformed, target):
        ...
        # SSIM (structural similarity) - FIXED data_range
        # Ensure inputs are properly normalized [0,1]
    ...
    def create_professional_comparison(self, original, transformed, target, pair_id, save_path):
        ...
        # Images - FIXED clipping by normalizing to [0,1]
...
def main():
    ...
    print("🎬 PROFESSIONAL COLOR ANALYSIS FOR CINEMA v1.4l - FIXED")
