#!/usr/bin/env python3
"""
Roadshow Film - Windows Compatible Deployment Setup Script
...
def create_frontend_files():
    ...
    with open("roadshow-film/frontend/package.json", "w", encoding='utf-8') as f:
...
module.exports = nextConfig'''
    ...
    with open("roadshow-film/frontend/next.config.js", "w", encoding='utf-8') as f:
        f.write(next_config)
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        'roadshow-orange': '#fb923c',
        'roadshow-black': '#000000',
        'roadshow-gray': '#1f2937',
      },
      fontFamily: {
        'roadshow': ['system-ui', 'sans-serif'],
      }
    },
  },
  plugins: [],
    ...
    with open("roadshow-film/frontend/tailwind.config.js", "w", encoding='utf-8') as f:
  ...
  plugins: {
    ...
    with open("roadshow-film/frontend/postcss.config.js", "w", encoding='utf-8') as f:
        f.write(postcss_config)
    
    # Main page (index.js) - No emojis
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <header className="p-8 text-center">
        ...
        >
          roadshow <span className="text-roadshow-orange">film</span>
        </motion.h1>
    ...
    with open("roadshow-film/frontend/pages/index.js", "w", encoding='utf-8') as f:
        f.write(index_js)
    
    # API route
    api_route = '''export const config = {
  api: {
    bodyParser: false,
  },
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    with open("roadshow-film/frontend/pages/api/process-video.js", "w", encoding='utf-8') as f:
        f.write(api_route)
...
export default function FilmLens({ onFileUpload, isProcessing }) {
  ...
  return (
    <motion.div
      className="border-2 border-dashed border-roadshow-orange rounded-lg p-12 text-center mb-8"
      onDrop={handleDrop}
    ...
    >
      {isProcessing ? (
        <div className="space-y-4">
          <div className="animate-spin w-8 h-8 border-2 border-roadshow-orange border-t-transparent rounded-full mx-auto"></div>
        ...
        <div className="space-y-4">
          ...
          <label
            htmlFor="file-input"
            className="inline-block px-6 py-3 bg-roadshow-orange text-black rounded-lg cursor-pointer hover:bg-orange-300 transition-colors"
          >
            Choose File
          </label>
        </div>
    ...
    with open("roadshow-film/frontend/components/FilmLens.js", "w", encoding='utf-8') as f:
        f.write(film_lens)
...
export default function Controls({ values, onChange }) {
  ...
  return (
    <motion.div
      className="bg-roadshow-gray rounded-lg p-6 mb-8"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {controls.map(({ key, label, min, max, step }) => (
          <div key={key} className="space-y-2">
            ...
            />
            <div className="text-right text-sm text-roadshow-orange">
    ...
    with open("roadshow-film/frontend/components/Controls.js", "w", encoding='utf-8') as f:
        f.write(controls)
...
export default function Preview({ original, processed }) {
  return (
    <motion.div
      className="bg-roadshow-gray rounded-lg p-6"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <div className="mt-6 text-center">
        <a
          ...
          className="inline-block px-6 py-3 bg-roadshow-orange text-black rounded-lg hover:bg-orange-300 transition-colors"
        >
    ...
    with open("roadshow-film/frontend/components/Preview.js", "w", encoding='utf-8') as f:
        f.write(preview)
...
body {
  font-family: 'system-ui', sans-serif;
    ...
    with open("roadshow-film/frontend/styles/globals.css", "w", encoding='utf-8') as f:
        f.write(global_css)
...
python-dotenv==1.0.0'''
    ...
    with open("roadshow-film/backend/requirements.txt", "w", encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    with open("roadshow-film/backend/app.py", "w", encoding='utf-8') as f:
        f.write(app_py)
...
class CinemaProcessor:
    ...
    with open("roadshow-film/backend/utils/video_processor.py", "w", encoding='utf-8') as f:
...
CMD ["python", "app.py"]'''
    ...
    with open("roadshow-film/backend/Dockerfile", "w", encoding='utf-8') as f:
        f.write(dockerfile)
...
PORT = { default = "8000" }'''
    ...
    with open("roadshow-film/railway.toml", "w", encoding='utf-8') as f:
    ...
    with open("roadshow-film/vercel.json", "w", encoding='utf-8') as f:
...
'''
    ...
    with open("roadshow-film/README.md", "w", encoding='utf-8') as f:
        f.write(readme)
...
.vercel/'''
    ...
    with open("roadshow-film/.gitignore", "w", encoding='utf-8') as f:
        f.write(gitignore)
...
def copy_model_files():
    ...
    files_to_copy = [
        ("cinema_v1_4m.py", "roadshow-film/backend/model/cinema_v1_4m.py"),
        ("models/cinema_v1_4m_model.pth", "roadshow-film/backend/models/cinema_v1_4m_model.pth")
    ]
    ...
    for source_path, dest_path in files_to_copy:
        ...
        if source.exists():
            ...
            copy_instructions.append(f"   Manual copy needed: {source_path} -> {dest_path}")
...
echo See README.md for detailed deployment instructions'''
    ...
    with open("roadshow-film/deploy.bat", "w", encoding='utf-8') as f:
        f.write(deploy_bat)
...
if [ ! -f "package.json" ] && [ ! -f "roadshow-film/package.json" ]; then
    echo "Run this script from the roadshow-film directory or its parent"
    exit 1
fi
...
echo "See README.md for detailed deployment instructions"'''
    ...
    with open("roadshow-film/deploy.sh", "w", encoding='utf-8') as f:
        f.write(deploy_sh)
